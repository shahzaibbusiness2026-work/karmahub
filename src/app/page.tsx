  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="max-w-[1240px] mx-auto px-4 sm:px-6 py-8 w-full space-y-10 flex-1">
        ...
        {/* Full Filterable Inventory — Placed Prominently Front & Center */}
        <div id="featured-listings" className="scroll-mt-24" />
        <section id="all-accounts" className="space-y-6 scroll-mt-24" aria-labelledby="all-accounts-heading">
          <div>
          ...
          {/* Comprehensive Inventory Filters (Age: 1m, 3m, 6m, 1y, 2y, 3y; Karma: Post, Comment, Total; Sort By; View Mode) */}
          {!showComingSoon && (
            <InventoryFilters
              filters={filterState}
